    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoMatches.equals(_existingMatches)) {
          throw new IllegalStateException("Migration didn't properly handle matches(com.rifqimfahmi.foorballapps.models.Match).\n"
                  + " Expected:\n" + _infoMatches + "\n"
                  + " Found:\n" + _existingMatches);
        }
        ...
        if (! _infoTeams.equals(_existingTeams)) {
          throw new IllegalStateException("Migration didn't properly handle teams(com.rifqimfahmi.foorballapps.models.Team).\n"
                  + " Expected:\n" + _infoTeams + "\n"
                  + " Found:\n" + _existingTeams);
        }
        ...
        if (! _infoPlayers.equals(_existingPlayers)) {
          throw new IllegalStateException("Migration didn't properly handle players(com.rifqimfahmi.foorballapps.models.Player).\n"
                  + " Expected:\n" + _infoPlayers + "\n"
                  + " Found:\n" + _existingPlayers);
        }
        ...
        if (! _infoFavoriteMatches.equals(_existingFavoriteMatches)) {
          throw new IllegalStateException("Migration didn't properly handle favorite_matches(com.rifqimfahmi.foorballapps.models.FavoriteMatch).\n"
        ...
        if (! _infoFavoriteTeams.equals(_existingFavoriteTeams)) {
          throw new IllegalStateException("Migration didn't properly handle favorite_teams(com.rifqimfahmi.foorballapps.models.FavoriteTeam).\n"
                  + " Expected:\n" + _infoFavoriteTeams + "\n"
